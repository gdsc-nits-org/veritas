...
app.use(`${Constants.Server.ROOT}/lead`, Routers.Lead);
app.use(`${Constants.Server.ROOT}/application`, Routers.Application);
app.use(
  `${Constants.Server.ROOT}/applicationOpening`,
  Routers.ApplicationOpening
);
